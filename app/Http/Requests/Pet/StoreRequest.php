...
class StoreRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'raza_mascota.string' => 'La raza debe ser una cadena de texto.',
            'raza_mascota.max' => 'La raza no debe exceder los 50 caracteres.',
            'especie_mascota.string' => 'La especie debe ser una cadena de texto.',
            'especie_mascota.max' => 'La especie no debe exceder los 50 caracteres.',
